    ...
    if fine_box.ndim == 2:
        if primal_directions[0] and primal_directions[1]:
            ...
            fine_data[gX + 1:-(gX - 1):cad, gY + 1:-(gY - 1):cad] = \
                0.5*data[gX:-gX, gY:-gY] + 0.5*data[gX + 1:-(gX - 1),gY + 1:-(gY - 1)]

            fine_data[gX :-(gX - 1):cad, gY + 1:-(gY - 1):cad]    = \
                0.5*data[gX:-gX, gY:-gY] + 0.5*data[gX + 1:-(gX - 1),gY + 1:-(gY - 1)]

            fine_data[gX +1 :-(gX - 1):cad, gY :-(gY - 1):cad]    = \
                0.5*data[gX:-gX, gY:-gY] + 0.5*data[gX + 1:-(gX - 1),gY + 1:-(gY - 1)]

        elif not primal_directions[0] and not primal_directions[1]:
            raise ValueError("not finished")
            fine_data[gX:-(gX + 1):cad, gY:-(gY + 1):cad] = 0.25*data[gX - 1:-(gX + 1), gY - 1:-(gY + 1)] + 0.75*data[gX:-gX, gY:-gY]
            fine_data[gX + 1:-(gX - 1):cad, gY + 1:-(gY - 1):cad] = 1
            fine_data[gX :-(gX - 1):cad, gY + 1:-(gY - 1):cad]    = 1
            fine_data[gX +1 :-(gX - 1):cad, gY :-(gY - 1):cad]    = 1

        elif primal_directions[0] and not primal_directions[1]:
            raise ValueError("not finished")
            fine_data[gX:-gX:cad, gY:-(gY + 1):cad]               = 1
            fine_data[gX + 1:-(gX - 1):cad, gY + 1:-(gY - 1):cad] = 1
            fine_data[gX :-(gX - 1):cad, gY + 1:-(gY - 1):cad]    = 1
            fine_data[gX +1 :-(gX - 1):cad, gY :-(gY - 1):cad]    = 1
            ...
            raise ValueError("not finished")
            fine_data[gX:-(gX + 1):cad, gY:-gY:cad]               = 1
            fine_data[gX + 1:-(gX - 1):cad, gY + 1:-(gY - 1):cad] = 1
            fine_data[gX :-(gX - 1):cad, gY + 1:-(gY - 1):cad]    = 1
            fine_data[gX +1 :-(gX - 1):cad, gY :-(gY - 1):cad]    = 1
